...
export default function ModeToggle() {
    ...
    return (
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-xs">
        ...
        <button
          ...
          className="text-muted-foreground hover:text-foreground rounded px-1 underline-offset-2 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
        >
          reset to showcase
        </button>
      </div>
  ...
  return (
    <div className="rounded border border-accent/40 bg-accent/5 px-4 py-3 flex flex-wrap items-center justify-between gap-3">
      ...
      >
        ▶ start learning · track my progress
      </button>
    </div>
  );
}
