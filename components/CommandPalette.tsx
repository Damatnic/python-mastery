  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 left-4 z-40 inline-flex items-center gap-1.5 rounded border border-border/70 bg-card/80 px-2.5 py-1.5 font-mono text-xs text-muted-foreground backdrop-blur hover:text-foreground hover:border-accent/50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
      ...
      {open && (
        <div
          className="fixed inset-0 z-[60] flex items-start justify-center bg-background/80 backdrop-blur-sm px-4 pt-[14vh]"
        ...
        >
          <div
            ...
            className="w-full max-w-xl rounded border border-border bg-card font-mono text-sm shadow-2xl"
          >
            <div className="flex items-center justify-between border-b border-border/60 px-3 py-1.5 text-xs text-muted-foreground">
              <span>command · type <span className="text-foreground/80">help</span></span>
